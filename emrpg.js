    ...
    enterRoomId(id) {
        if (id === "mysterytrailer") {
            ...
            if (endIDs.includes(id)) {
                ...
                this.enterScene(scene_closet);
            } else if (id === "mediaside") {
                this.enterScene(scene_main);
            } else if (id === "fivekback") {
                this.enterScene(scene_main);
            } else if (id === "fivekfront") {
                this.enterScene(scene_main);
...
{
id: "cudabac",
desc: "You are in !c!Mr. !c!Cudabac’s room. He is flexing his small piece of ancient roman pottery in front of a very impressed class. There are a few black ink stains on the table in the front that vaguely make out the shape of a faded QR Code.",
options: [
...
{
id: "pittman",
desc: "Inside !c!Mr. !c!Pittman’s !p!classroom. He is lecturing students on their fundamental misunderstanding of the way in which restaurants function. He explains that they do not just have food already and actually have to purchase it. Though he doe",
options: [
],
},
{
...
{
id: "esl2",
desc: "You are in an !s!English !c!as !s!a !s!second !s!language !p!classroom . The students' progress is coming along nicely. They are all gathered around a large ancient book and seem to be attempting to unencrypt whatever ancient secrets it holds within its pages. They all are holding magnifying glasses to the text and closely examining every character. Anything could be a clue.",
options: [
],
back: "Exit",
},
